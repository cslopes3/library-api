...
describe('[E2E] - Return item by id', () => {
    ...
    test('[PATCH] /reservations/return-item/:id', async () => {
        ...
        const returnedItemId = reservation.reservationItem[0].id.toString();
        const response = await request(app.getHttpServer())
            .patch(`/reservations/return-item/${returnedItemId}`)
        ...
        expect(reservationItemOnDatabase[1]?.returned).toBeFalsy();
    });
});
